% Created by tikzDevice version 0.7.0 on 2015-08-31 18:21:08
...
\path[draw=drawColor,line width= 1.7pt,line join=round] ( 29.95,170.43) --
	( 84.43,183.59) --
	(138.90,152.00) --
	(193.38,154.64) --
	(247.86,117.79);
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at ( 29.95,158.56) {5.5};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at ( 84.43,187.54) {6.0};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at (138.90,140.13) {4.8};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at (193.38,158.59) {4.9};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at (247.86,105.92) {3.5};
