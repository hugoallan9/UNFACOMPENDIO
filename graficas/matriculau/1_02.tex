% Created by tikzDevice version 0.7.0 on 2015-08-31 18:39:00
...
\path[draw=drawColor,line width= 1.7pt,line join=round] ( 33.83, 97.94) --
	( 87.46,109.46) --
	(141.09,108.13) --
	(194.73, 94.87) --
	(248.36,183.59);
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at ( 33.83, 86.07) {5.8};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at ( 87.46,113.41) {7.6};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.01] at (141.09,112.08) {7.4};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at (194.73, 83.00) {5.4};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at (248.36,187.54) {18.7};
