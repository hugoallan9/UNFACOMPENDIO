% Created by tikzDevice version 0.7.0 on 2015-08-31 18:40:38
...
\path[draw=drawColor,line width= 1.7pt,line join=round] ( 33.83,146.59) --
	( 87.46,137.24) --
	(141.09,153.61) --
	(194.73,159.72) --
	(248.36,183.59);
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at ( 33.83,150.54) {38.1};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at ( 87.46,125.37) {37.1};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.01] at (137.98,153.61) {38.9};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.01] at (191.61,159.72) {39.6};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.01] at (248.36,187.54) {42.1};
